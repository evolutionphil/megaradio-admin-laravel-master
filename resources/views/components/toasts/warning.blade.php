<div x-data="{ isVisible: false, timeout: null }"
     x-cloak
     x-show="isVisible"
     class="pointer-events-auto relative rounded-sm border border-orange-500 bg-white text-neutral-600 dark:bg-neutral-950 dark:text-neutral-300"
     ...
     aria-live="polite"
     aria-atomic="true">
    <div class="flex w-full items-center gap-2.5 bg-orange-500/10 rounded-sm p-4 transition-all duration-300">

        <!-- Icon -->
        <div class="rounded-full bg-orange-500/15 p-0.5 text-orange-500" aria-hidden="true">
        ...
        <div class="flex flex-col gap-1">
            ...
            <p x-cloak
               ...
               class="text-pretty text-sm text-orange-500"
